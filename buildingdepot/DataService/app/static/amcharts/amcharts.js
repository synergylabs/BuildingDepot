(function () {
    ...
    document.attachEvent && (d.isNN = !1, d.isIE = !0, d.isModern || (d.dx =
        0, d.dy = 0));
    ...
    d.callInitHandler = function (a) {
        ...
        if (d.initHandlers) for (var c = 0; c < b.length; c++) {
            var e = b[c];
            e.types ? d.isInArray(e.types,
                a.type) && e.method(a) : e.method(a)
        }
    };
    ...
    d.isIE && (document.attachEvent("onmousemove", d.handleMouseMove), document.attachEvent("onmouseup", d.handleMouseUp), window.attachEvent("onload",
        d.handleLoad), document.attachEvent("onmousewheel", d.handleWheel));
    d.clear = function () {
        var a = d.charts;
    ...
    d.update = function () {
        ...
        d.updateCount++;
        var b = !1;
        d.updateCount == d.validateAt && (b = !0, d.updateCount =
            0);
...
(function () {
    ...
    d.addPrefix = function (a, b, c, e, h) {
        ...
        } else for (k = 0; k < c.length; k++) if (a <=
            c[k].number) {
            l = a / c[k].number;
...
(function () {
    ...
    d.AxisBase = d.Class({
        construct: function (a) {
            ...
            this.periods = [{period: "fff", count: 1}, {
                period: "fff",
                count: 5
            }, {period: "fff", count: 10}, {period: "fff", count: 50}, {period: "fff", count: 100}, {
                period: "fff",
                count: 500
            }, {period: "ss", count: 1}, {period: "ss", count: 5}, {period: "ss", count: 10}, {
                period: "ss",
                count: 30
                ...
                period: "DD",
                count: 4
            }, {period: "DD", count: 5}, {period: "WW", count: 1},
            ...
            this.nextPeriod =
                {fff: "ss", ss: "mm", mm: "hh", hh: "DD", DD: "MM", MM: "YYYY"};
            ...
            if (a) {
                ...
                this.marginsChanged ? (a.translate(b,
                    c), this.tx = b, this.ty = c) : a.translate(this.tx, this.ty);
            ...
            var b = a.graphics.getBBox(), c = this.x + b.x + b.width /
                2, b = this.y + b.y + b.height / 2, e = a.fillColor;
            ...
            var u,
                ...
                y = d.getPeriodDuration(A, v);
            y < k && (A = g.period, v = g.count, y = k);
            g = A;
            "WW" == g && (g = "DD");
            this.stepWidth = this.getStepWidth(this.timeDifference);
            var B = Math.ceil(this.timeDifference / y) + 5,
                D = l = d.resetDateToMin(new Date(this.startTime - y), A, v, t).getTime();
            if (g == A && 1 == v && this.centerLabelOnFullPeriod || this.autoWrap || this.centerLabels) n = y * this.stepWidth, this.autoWrap && !this.centerLabels && (n = -n);
            this.cellWidth = k * this.stepWidth;
            q = Math.round(l / y);
            k = -1;
            q / 2 ==
            Math.round(q / 2) && (k = -2, l -= y);
            q = this.firstTime;
            var C = 0, J = 0;
            a && 1 < v && (u = this.chooseMinorFrequency(v), z = d.getPeriodDuration(A, u), "DD" == A && (z += d.getPeriodDuration("hh")), "fff" == A && (z = 1));
            if (0 < this.gridCountR) for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
                ...
                "DD" == A && (p += 36E5);
                p = d.resetDateToMin(new Date(p), A, v, t).getTime();
                "MM" == A && (h = (p - l) / y, 1.5 <= (p - l) / y && (p = p - (h - 1) * y + d.getPeriodDuration("DD", 3), p = d.resetDateToMin(new Date(p),
                    A, 1).getTime(), C += y));
                h = (p - this.startTime) * this.stepWidth;
                if ("radar" == b.type) {
                    if (h = this.axisWidth - h, 0 > h || h > this.axisWidth) continue
                } else this.rotate ? "date" == this.type && "middle" == this.gridPosition && (J = -y * this.stepWidth / 2) : "date" == this.type && (h = this.axisWidth - h);
                f = !1;
                ...
                if (a == k && !c || a == B && !e) f = " ";
                this.labelFunction && (f = this.labelFunction(f, new Date(p), this, A, v, m).toString());
                this.boldLabels && (l = !0);
                m = new this.axisItemRenderer(this, h, f, !1, n, J, !1, l);
                this.pushAxisItem(m);
                m = l = p;
                if (!isNaN(u)) for (h = 1; h < v; h += u) this.gridAlpha = this.minorGridAlpha, f = p + z * h, f = d.resetDateToMin(new Date(f), A, u, t).getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) * this.stepWidth, void 0, void 0, void 0, void 0, void 0, void 0,
                    void 0, !0), this.pushAxisItem(f);
                this.gridAlpha = x
            }
            ...
            var a =
                d.extractPeriod(this.minPeriod);
            ...
            if (this.balloon && void 0 !== e && this.balloon.enabled) {
                ...
                if (a != this.prevBX || b != this.prevBY) this.balloon.setPosition(a,
                    b), this.prevBX = a, this.prevBY = b, e && this.balloon.showBalloon(e)
            }
...
(function () {
    ...
    d.ValueAxis = d.Class({
        inherits: d.AxisBase, construct: function (a) {
            ...
            isNaN(this.maxZoom) && (this.fullMin = this.min, this.fullMax = this.max, "date" != this.type && (isNaN(this.minimum) || (this.fullMin = this.minimum), isNaN(this.maximum) || (this.fullMax = this.maximum)), this.logarithmic && (this.fullMin = this.logMin, 0 === this.fullMin && (this.fullMin = this.treatZeroAs)), "date" == this.type && (this.minimumDate || (this.fullMin = this.minRR), this.maximumDate || (this.fullMax = this.maxRR))))
        }, draw: function () {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) e = !0; else {
                ...
                var m =
                    this.labelFrequency, n = this.showFirstLabel, q = this.showLastLabel, p = 1, t = 0;
                ...
                !0 === h ? (u = Math.log(this.max) * Math.LOG10E - Math.log(this.minReal) * Math.LOG10E, this.stepWidth = this.axisWidth / u, u > this.logGridLimit && (r = Math.ceil(Math.log(this.max) * Math.LOG10E) +
                ...
                g.thousandsSeparator =
                    a.nf.thousandsSeparator;
                ...
                if (this.autoGridCount || 0 !== this.gridCount) if ("date" == c) this.generateDFObject(), this.timeDifference = this.max - this.min, this.maxTime = this.lastTime =
                    this.max, this.startTime = this.firstTime = this.min, this.parseDatesDraw(); else for (r >= this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), c = this.minCalc, h && (r++, c = this.maxCalc - r * x), g = t; g < r; g += p) if (t = x * g + c, t = d.roundTo(t, this.maxDecCount + 1), !this.integersOnly || Math.round(t) == t) if (isNaN(z) || Number(d.toFixed(t, z)) == t) {
                    if (!0 === h) if (u > this.logGridLimit) t = Math.pow(10, g); else if (0 >= t && (t = c + x * g + x / 2, 0 >= t)) continue;
                    v = this.formatValue(t, !1, g);
                    Math.round(g / m) != g / m && (v = void 0);
                    if (0 === g && !n || g == r - 1 && !q) v = " ";
                    f = this.getCoordinate(t);
                    var B;
                    this.rotate && this.autoWrap && (B = this.stepWidth * x - 10);
                    v = new this.axisItemRenderer(this, f, v, void 0, B, void 0, void 0, this.boldLabels);
                    this.pushAxisItem(v);
                    if (t == this.baseValue && "radar" != a.type) {
                        var D, C;
                        v = this.width;
                        var J = this.height;
                        "H" == this.orientation ? 0 <= f && f <= v + 1 && (D = [f, f, f + k], C = [J, 0, l]) : 0 <= f && f <= J + 1 && (D = [0, v, v + k], C = [f, f, f + l]);
                        D && (v = d.fitToBounds(2 * this.gridAlpha, 0, 1), isNaN(this.zeroGridAlpha) || (v = this.zeroGridAlpha), v = d.line(a.container,
                            D, C, this.gridColor, v, 1, this.dashLength), v.translate(this.x, this.y), this.grid0 = v, a.axesSet.push(v), v.toBack(), d.setCN(a, v, this.bcn + "zero-grid-" + this.id), d.setCN(a, v, this.bcn + "zero-grid"))
                    }
                    if (!isNaN(y) && 0 < A && g < r - 1) {
                        v = x / y;
                        h && (y = x * (g + p) + this.minCalc, y = d.roundTo(y, this.maxDecCount + 1), u > this.logGridLimit && (y = Math.pow(10, g + p)), v = 9, y = (y - t) / v);
                        f = this.gridAlpha;
                        this.gridAlpha = this.minorGridAlpha;
                        for (J = 1; J < v; J++) {
                            var H = this.getCoordinate(t + y * J),
                                H = new this.axisItemRenderer(this, H, "", !1, 0, 0, !1, !1, 0, !0);
                            this.pushAxisItem(H)
                        }
                        this.gridAlpha =
                            f
                ...
                if (0 < B) {
                    D = this.fillAlpha;
                    for (g = this.fillAlpha = 0; g < B; g++) C = u[g], k = NaN, y = C.above, isNaN(C.toValue) || (k = this.getCoordinate(C.toValue), v = new this.axisItemRenderer(this, k, "", !0, NaN, NaN, C), this.pushAxisItem(v, y)), l = NaN, isNaN(C.value) || (l = this.getCoordinate(C.value), v = new this.axisItemRenderer(this, l, C.label, !0, NaN, (k - l) / 2, C), this.pushAxisItem(v, y)), isNaN(k) && (l -= 3, k = l + 3), isNaN(k - l) || 0 > l && 0 > k || (k = new this.guideFillRenderer(this, l, k, C), this.pushAxisItem(k, y), y = k.graphics(), C.graphics =
                        y, C.balloonText && this.addEventListeners(y, C));
                    this.fillAlpha = D
                }
                g = this.baseValue;
        ...
        formatValue: function (a, b, c) {
            ...
            b && 1 < a && (f.precision = 0)) : f.precision = -1), c = this.usePrefixes ? d.addPrefix(a, g.prefixesOfBigNumbers, g.prefixesOfSmallNumbers, f, !b) : d.formatNumber(a, f, f.precision)), this.duration && (b && (f.precision = 0), c = d.formatDuration(a, this.duration, "", this.durationUnits, this.maxInterval, f)), "date" == this.type && (c = d.formatDate(new Date(a), this.currentDateFormat, g)), this.recalculateToPercents ? c += "%" : (b = this.unit) && (c = "left" == this.unitPosition ? b + c : c + b), this.labelFunction && (c = "date" == this.type ? this.labelFunction(c, new Date(a),
                this).toString() : this.labelFunction(a, c, this).toString()), c
            ...
            for (p = n; p <= l; p++) {
                var u = 0;
                for (q = 0; q < k.length; q++) if (n = k[q], n.hidden) n.newStack && (h[p] = NaN,
                    e[p] = NaN); else if (m = n.type, n.chart == this.chart && n.valueAxis == this && a == m && n.stackable) if (m = this.data[p].axes[this.id].graphs[n.id], g = m.values.value, isNaN(g)) n.newStack && (h[p] = NaN, e[p] = NaN); else {
                    ...
                    "regular" == b && (r && (isNaN(c[p]) ? (c[p] = g, m.values.close = g, m.values.open = this.baseValue) : (isNaN(g) ? m.values.close =
            ...
            for (p = this.start; p <= this.end; p++) for (q = 0; q < k.length; q++) (n = k[q], n.hidden) ? n.newStack && (h[p] = NaN, e[p] = NaN) : (m = n.type, n.chart == this.chart && n.valueAxis ==
        ...
        getExtremes: function (a, b) {
            ...
            for (d = a; d <= b; d++) {
                ...
                for (g in f) if (f.hasOwnProperty(g)) {
                    ...
                    if (k.includeInMinMax && (!k.hidden || this.includeHidden)) {
                        ...
                        var l;
                        if (this.minMaxField) l = k[this.minMaxField], l < c && (c = l), l > e && (e = l); else for (var m in k) k.hasOwnProperty(m) && "percents" != m && "total" != m && (l = k[m], l < c && (c = l),
                        l > e && (e = l))
                    }
                }
            }
            ...
            this.listenTo(this.synchronizeWith,
...
(function () {
    ...
    d.RecItem = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            void 0 == u && (u = p.color);
            void 0 !== n && (u = n);
            var x = a.chart.container, z = x.set();
            this.set = z;
            var v = a.axisThickness, A = a.axisColor, y = a.axisAlpha, B = a.tickLength, D = a.gridAlpha,
                C = a.gridThickness, J = a.gridColor, H = a.dashLength, S = a.fillColor, O = a.fillAlpha,
                Q = a.labelsEnabled;
            n = a.labelRotationR;
            var ia = a.counter, I = a.inside, Z = a.labelOffset, va = a.dx, ma = a.dy, Oa = a.orientation,
                ea = a.position, ca = a.previousCoord, X = a.height, ya = a.width, da = a.offset, fa, za;
            g ? (void 0 !== g.id && (q = p.classNamePrefix + "-guide-" + g.id), Q = !0, isNaN(g.tickLength) || (B = g.tickLength), void 0 != g.lineColor && (J = g.lineColor), void 0 != g.color && (u = g.color), isNaN(g.lineAlpha) || (D = g.lineAlpha), isNaN(g.dashLength) || (H = g.dashLength), isNaN(g.lineThickness) || (C = g.lineThickness), !0 === g.inside && (I = !0, 0 < da && (da = 0)), isNaN(g.labelRotation) ||
            (n = g.labelRotation), isNaN(g.fontSize) || (r = g.fontSize), g.position && (ea = g.position), void 0 !== g.boldLabel && (k = g.boldLabel), isNaN(g.labelOffset) || (Z = g.labelOffset)) : "" === c && (B = 0);
            m && !isNaN(a.minorTickLength) && (B = a.minorTickLength);
            var ga = "start";
            0 < h && (ga = "middle");
            a.centerLabels && (ga = "middle");
            var T = n * Math.PI / 180, Y, Ca, G = 0, w = 0, na = 0, ha = Y = 0, Pa = 0;
            "V" == Oa && (n = 0);
            var ba;
            ...
            if ("H" == Oa) {
                if (0 <= b && b <= ya + 1 && (0 < B && 0 < y && b + l <= ya + 1 && (fa = d.line(x, [b + l, b + l], [0, B], A, y, C), z.push(fa)), 0 < D && (za = d.line(x, [b, b + va, b + va], [X, X + ma, ma], J, D, C, H), z.push(za))), w = 0, G = b, g && 90 == n && I && (G -= r), !1 === e ? (ga = "start", w = "bottom" == ea ? I ? w + B : w - B : I ? w - B : w + B, G += 3, 0 < h && (G += h / 2 - 3, ga = "middle"), 0 < n && (ga = "middle")) : ga = "middle", 1 == ia && 0 < O && !g && !m && ca < ya && (e = d.fitToBounds(b, 0, ya), ca = d.fitToBounds(ca, 0, ya), Y = e - ca, 0 < Y && (Ca = d.rect(x, Y, a.height, S, O), Ca.translate(e - Y + va, ma), z.push(Ca))), "bottom" == ea ? (w += X + r / 2 + da, I ? (0 < n ?
                    ...
                    ha / 2 * Math.cos(T)), ba && (r = 0, I && (r = ha / 2 * Math.cos(T)), f + r > ya + 2 || 0 > f)) ba.remove(), ba = null
            } else {
                0 <= b && b <= X + 1 && (0 < B && 0 < y && b + l <= X + 1 && (fa = d.line(x, [0, B + 1], [b + l, b + l], A, y, C), z.push(fa)), 0 < D && (za = d.line(x, [0, va, ya + va], [b, b + ma, b + ma], J, D, C, H), z.push(za)));
                ga = "end";
                if (!0 === I && "left" == ea || !1 === I && "right" == ea) ga = "start";
                w = b - Pa / 2 + 2;
                1 == ia && 0 < O && !g && !m && (e = d.fitToBounds(b, 0, X), ca = d.fitToBounds(ca, 0, X), T = e - ca, Ca = d.polygon(x, [0, a.width, a.width, 0], [0, 0, T, T], S, O), Ca.translate(va, e - T + ma), z.push(Ca));
                w += r / 2;
                "right" == ea ? (G +=
                    va + ya + da, w += ma, I ? (f || (w -= r / 2 + 3), G = G - (B + 4) - Z) : (G += B + 4 + v, w -= 2, G += Z)) : I ? (G += B + 4 - da, f || (w -= r / 2 + 3), g && (G += va, w += ma), G += Z) : (G += -B - v - 4 - 2 - da, w -= 2, G -= Z);
                fa && ("right" == ea ? (na += va + da + ya - 1, Y += ma, na = I ? na - v : na + v) : (na -= da, I || (na -= B + v)));
                f && (w += f);
                I = -3;
                "right" == ea && (I += ma);
                ba && (w > X + 1 || w < I) && (ba.remove(), ba = null)
            }
            ...
            ba && (ba.attr({"text-anchor": ga}), ba.translate(G,
                w, NaN, !0), 0 !== n && ba.rotate(-n, a.chart.backgroundColor), a.allLabels.push(ba), this.label = ba, d.setCN(p, ba, a.bcn + "label"), d.setCN(p, ba, q, !0), g && d.setCN(p, ba, "guide"));
...
(function () {
    ...
    d.RecFill = d.Class({
        construct: function (a, b, c, e) {
            ...
            "V" == g ? (g = d.rect(l, a.width, c, n, m), g.translate(h, b - k + f)) : (g = d.rect(l,
                c, a.height, n, m), g.translate(b - k + h, f));
    ...
    d.AmChart = d.Class({
        construct: function (a) {
            ...
            if (a = "object" != typeof a ? document.getElementById(a) : a) {
                ...
                var b = this.chartDiv, c = this.legendDiv,
                ...
                this.amExport && d.AmExport && (this.AmExport = d.extend(this.amExport, new d.AmExport(this),
                    !0));
            ...
            d.VML || d.SVG ? (a.handDrawn = this.handDrawn, a.handDrawScatter = this.handDrawScatter, a.handDrawThickness = this.handDrawThickness, d.remove(this.set), this.set = a.set(), d.remove(this.gridSet), this.gridSet = a.set(), d.remove(this.cursorLineSet), this.cursorLineSet = a.set(), d.remove(this.graphsBehindSet), this.graphsBehindSet = a.set(), d.remove(this.bulletBehindSet), this.bulletBehindSet = a.set(), d.remove(this.columnSet), this.columnSet =
                ...
                this.plotBalloonsSet = a.set(), d.remove(this.zoomButtonSet), this.zoomButtonSet = a.set(), d.remove(this.zbSet), this.zbSet = null, d.remove(this.linkSet), this.linkSet = a.set()) : this.fire({
                type: "failed",
                chart: this
            })
        }, premeasure: function () {
            ...
            try {
                document.removeEventListener("touchstart", this.docfn1, !0), document.removeEventListener("touchend",
                    this.docfn2, !0)
            } catch (b) {
            }
        ...
        updateWidth: function () {
            ...
            this.chartDiv && (this.chartDiv.style.msTouchAction = "auto", this.chartDiv.style.touchAction = "auto")
            ...
            }, document.addEventListener("touchstart", a.docfn1, !0), document.addEventListener("touchend",
                a.docfn2, !0)), b.addEventListener("mousedown", function (b) {
                a.mouseIsOver = !0;
                a.handleMouseMove.call(a, b);
            ...
            a.checkDisplay();
            if (a.divRealWidth !=
                a.previousWidth || a.divRealHeight != a.previousHeight) {
                var b = a.legend;
            ...
            this.hideBalloonReal();
            a && (a.touches && this.tapToActivate && !this.tapped ||
                !this.panRequired) || (this.handleMouseMove(a), this.handleMouseDown(a))
        ...
        animate: function (a, b, c, e, h, f, g) {
            ...
            if (this.animations) for (a = this.animations.length - 1; 0 <= a; a--) {
                var b = this.animations[a], c = d.updateRate * b.time,
...
(function () {
    ...
    d.AmGraph = d.Class({
        construct: function (a) {
            ...
            var b = a.type;
            if (a.drawGraphs) {
                isNaN(this.precision) || (this.numberFormatter ?
                    this.numberFormatter.precision = this.precision : this.numberFormatter = {
                        precision: this.precision,
                ...
                d.ifArray(this.data) && (a = !1, "xy" == b ? this.xAxis.axisCreated && this.yAxis.axisCreated &&
                    (a = !0) : this.valueAxis.axisCreated && (a = !0), !this.hidden && a && this.createGraph());
                e.push(c)
            }
            ...
            var a =
                this.valueAxis.stackType, b = [], c = [], e = [], d = [], f, g, k, l, m;
            for (m = this.start; m <= this.end; m++) {
                ...
                if (isNaN(q)) this.connect || (this.drawLineGraph(b, c, e, d), b = [], c = [], e = [], d = []); else {
                    ...
                    "middle" == this.valueAxis.pointPosition && (r -= 180 / (this.end - this.start +
                        1));
                    ...
                    if (!isNaN(p)) {
                        var u = this.valueAxis.getCoordinate(p, this.noRounding) - this.height,
                            u = u * this.valueAxis.rMultiplier, x = u * Math.sin(r / 180 * Math.PI),
            ...
            if (e) {
                ...
                switch (m) {
                    ...
                    case "inside":
                        ...
                        break;
                    case "middle":
                        "column" == this.type && (l = !0, q ? b -= (b - r) / 2 + x - 3 : c -= (c - u) /
                            2 + x - 3)
                }
            ...
            isNaN(k) && (k = .8);
            var m = this.useNegativeColorIfDown, n = this.width, q = this.height,
                p = this.y, t = this.rotate, r = this.columnCount, u = d.toCoordinate(this.cornerRadiusTop, k / 2),
                x = this.connect, z = [], v = [], A, y, B, D, C = this.chart.graphs.length, J, H = this.dx / this.tcc,
                S = this.dy / this.tcc, O = f.stackType, Q = this.start, ia = this.end, I = this.scrollbar,
                Z = "graph-column-";
            ...
            var va = this.categoryAxis, ma = this.baseCoord, Oa = this.negativeBase, ea = this.columnIndex,
                ...
                za, ga = this.getGradRotation(), T = this.chart.columnSpacing,
                Y = va.cellWidth, Ca = (Y * k - r) / r;
            T > Ca && (T = Ca);
            var G, w, na, ha = q, Pa = n, ba = 0, tb = 0, ub, vb, gb, hb, wb = this.fillColorsR,
                Qa = this.negativeFillColors, Ja = this.negativeLineColor, Ya = this.fillAlphas,
            ...
            if (!(I || "line" != g && "smoothedLine" != g && "step" != g || (1 == e.length &&
            "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), !Qa && void 0 == Ja || m))) {
                var Ua = Oa;
                Ua > f.max && (Ua = f.max);
                Ua < f.min && (Ua = f.min);
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g) {
                if (0 < Q) {
                    for (L = Q - 1; -1 < L; L--) if (G = e[L], w = G.axes[f.id].graphs[b], na = w.values.value, !isNaN(na)) {
                        Q = L;
                        break
                    }
                    if (this.lineColorField) for (L = Q; -1 < L; L--) if (G = e[L], w = G.axes[f.id].graphs[b], w.lineColor) {
                        this.bulletColorSwitched = this.lineColorSwitched =
                            w.lineColor;
                        break
                    }
                    if (this.fillColorsField) for (L = Q; -1 < L; L--) if (G = e[L], w = G.axes[f.id].graphs[b], w.fillColors) {
                        this.fillColorsSwitched = w.fillColors;
                        break
                    }
                    if (this.dashLengthField) for (L = Q; -1 < L; L--) if (G = e[L], w = G.axes[f.id].graphs[b], !isNaN(w.dashLength)) {
                        this.dashLengthSwitched = w.dashLength;
                        break
                    }
                }
                if (ia < e.length - 1) for (L = ia + 1; L < e.length; L++) if (G = e[L], w = G.axes[f.id].graphs[b], na = w.values.value, !isNaN(na)) {
                    ia = L;
                    break
                }
            }
            ia < e.length - 1 && ia++;
            var U = [], V = [], Ra = !1;
            if ("line" == g || "step" == g || "smoothedLine" == g) if (this.stackable &&
                "regular" == O || "100%" == O || this.fillToGraph) Ra = !0;
            var Nb = this.noStepRisers, jb = -1E3, kb = -1E3, lb = this.minDistance, Sa = !0, $a = !1;
            for (L = Q; L <= ia; L++) {
                G = e[L];
                w = G.axes[f.id].graphs[b];
                w.index = L;
                var ab, Ta = NaN;
                ...
                var R, P, K, aa, ja = NaN, E = NaN, F = NaN, N = NaN, M = NaN, pa = NaN, qa = NaN, ra = NaN, sa = NaN,
                    wa = NaN, Da = NaN, ka = NaN, la = NaN, W = NaN, zb = NaN, Ab = NaN, ta = NaN, ua = void 0, Ma = wb,
                    Va = Ya, Ha = ya,
                    Aa, Ea, Bb = this.proCandlesticks, mb = this.topRadius, Fa = q - 1, oa = n - 1, bb = this.pattern;
                void 0 != w.pattern && (bb = w.pattern);
                isNaN(w.alpha) || (Va = w.alpha);
                isNaN(w.dashLength) || (da = w.dashLength);
                var Ia = w.values;
                f.recalculateToPercents && (Ia = w.percents);
                if (Ia) {
                    ...
                    isNaN(ta) || (M = f.getCoordinate(ta, xb), m && "regular" != O && "100%" !=
                    O && (Ta = ta, ta = M = NaN));
                    m && (void 0 == this.openField ? ab && (ab.isNegative = Ta < W ? !0 : !1, isNaN(Ta) && (w.isNegative = !Sa)) : w.isNegative = Ta > W ? !0 : !1);
                    ...
                    "start" ==
                    this.pointPosition && (ja -= Y / 2 + Math.floor(Wa * Y / 2), xa = 0, Ga = Math.floor(Y) + Math.floor(Wa * Y));
                    ...
                    if (!Bb && W < ta || Bb && W < za) w.isNegative = !0, Qa && (Ma = Qa), Za && (Va = Za), void 0 != Ja && (Ha = Ja);
                    $a = !1;
                    isNaN(W) ||
                    (m ? W > Ta ? (Sa && ($a = !0), Sa = !1) : (Sa || ($a = !0), Sa = !0) : w.isNegative = W < Oa ? !0 : !1, za = W);
                    var Ob = !1;
                    I && a.chartScrollbar.ignoreCustomColors && (Ob = !0);
                    Ob || (void 0 != w.color && (Ma = w.color), w.fillColors && (Ma = w.fillColors));
                    switch (g) {
                        case "line":
                            if (isNaN(W)) x || (this.drawLineGraph(z, v, U, V), z = [], v = [], U = [], V = []); else {
                                if (Math.abs(E - jb) >= lb || Math.abs(F - kb) >= lb) z.push(E), v.push(F), jb = E, kb = F;
                                wa = E;
                                Da = F;
                                ka = E;
                                la = F;
                                !Ra || isNaN(M) || isNaN(N) || (U.push(N), V.push(M));
                                if ($a || void 0 != w.lineColor && w.lineColor != this.lineColorSwitched || void 0 !=
                                    w.fillColors && w.fillColors != this.fillColorsSwitched || !isNaN(w.dashLength)) this.drawLineGraph(z, v, U, V), z = [E], v = [F], U = [], V = [], !Ra || isNaN(M) || isNaN(N) || (U.push(N), V.push(M)), m ? Sa ? (this.lineColorSwitched = ya, this.fillColorsSwitched = wb) : (this.lineColorSwitched = Ja, this.fillColorsSwitched = Qa) : (this.lineColorSwitched = w.lineColor, this.fillColorsSwitched = w.fillColors), this.dashLengthSwitched = w.dashLength;
                                w.gap && (this.drawLineGraph(z, v, U, V), z = [], v = [], U = [], V = [])
                            }
                            break;
                        case "smoothedLine":
                            if (isNaN(W)) x || (this.drawSmoothedGraph(z,
                                v, U, V), z = [], v = [], U = [], V = []); else {
                                if (Math.abs(E - jb) >= lb || Math.abs(F - kb) >= lb) z.push(E), v.push(F), jb = E, kb = F;
                                wa = E;
                                Da = F;
                                ...
                                la = F;
                                !Ra || isNaN(M) || isNaN(N) || (U.push(N), V.push(M));
                                void 0 == w.lineColor && void 0 == w.fillColors && isNaN(w.dashLength) || (this.drawSmoothedGraph(z, v, U, V), z = [E], v = [F], U = [], V = [], !Ra || isNaN(M) || isNaN(N) || (U.push(N), V.push(M)), this.lineColorSwitched = w.lineColor, this.fillColorsSwitched = w.fillColors, this.dashLengthSwitched = w.dashLength);
                                w.gap && (this.drawSmoothedGraph(z, v, U, V), z = [], v = [], U = [],
                                    V = [])
                            }
                            break;
                        case "step":
                            if (!isNaN(W)) {
                                t ? (isNaN(A) || (z.push(A), v.push(F - xa)), v.push(F - xa), z.push(E), v.push(F + Ga), z.push(E), !Ra || isNaN(M) || isNaN(N) || (isNaN(B) || (U.push(B), V.push(M - xa)), U.push(N), V.push(M - xa), U.push(N), V.push(M + Ga))) : (isNaN(y) || (v.push(y), z.push(E - xa)), z.push(E - xa), v.push(F), z.push(E + Ga), v.push(F), !Ra || isNaN(M) || isNaN(N) || (isNaN(D) || (U.push(N - xa), V.push(D)), U.push(N - xa), V.push(M), U.push(N + Ga), V.push(M)));
                                A = E;
                                y = F;
                                B = N;
                                D = M;
                                ...
                                ka = E;
                                la = F;
                                if ($a || void 0 != w.lineColor || void 0 != w.fillColors ||
                                    !isNaN(w.dashLength)) {
                                    var cc = z[z.length - 2], dc = v[v.length - 2];
                                    z.pop();
                                    v.pop();
                                    this.drawLineGraph(z, v, U, V);
                                    z = [cc];
                                    v = [dc];
                                    t ? (v.push(F + Ga), z.push(E)) : (z.push(E + Ga), v.push(F));
                                    U = [];
                                    V = [];
                                ...
                                if (Nb || w.gap) A = y = NaN, this.drawLineGraph(z, v, U, V), z = [], v = [], U = [], V = []
                            } else if (!x) {
                                if (1 >= this.periodSpan ||
                                    1 < this.periodSpan && E - A > xa + Ga) A = y = NaN;
                                this.drawLineGraph(z, v, U, V);
                                z = [];
                                v = [];
                                U = [];
                        ...
                        case "column":
                            Aa = Ha;
                            void 0 != w.lineColor && (Aa = w.lineColor);
                            if (!isNaN(W)) {
                                m || (w.isNegative = W < Oa ? !0 : !1);
                                w.isNegative && (Qa && (Ma = Qa), void 0 != Ja && (Aa = Ja));
                                var Pb = f.min, Qb = f.max, ob = ta;
                                isNaN(ob) && (ob = Oa);
                                if (!(W < Pb && ob < Pb || W > Qb && ob > Qb)) {
                                    var Ba;
                                    if (t) {
                                        "3d" == O ? (P = F - (r / 2 - this.depthCount + 1) * (k + T) + T / 2 + S * ea, R = N + H * ea, Ba = ea) : (P = Math.floor(F - (r / 2 - ea) * (k + T) + T / 2), R = N, Ba = 0);
                                        K = k;
                                        wa = E;
                                        Da = P + k / 2;
                                        ka = E;
                                        la = P + k / 2;
                                        P + K > q + Ba * S && (K = q - P + Ba * S);
                                        P < Ba * S && (K += P, P = Ba * S);
                                        aa = E - N;
                                        var ec = R;
                                        R = d.fitToBounds(R, 0, n);
                                        aa += ec - R;
                                        aa = d.fitToBounds(aa, -R, n - R + H * ea);
                                        w.labelIsNegative = 0 > aa ? !0 : !1;
                                        0 === aa && 1 / W === 1 / -0 && (w.labelIsNegative = !0);
                                        isNaN(G.percentWidthValue) || (K = this.height * G.percentWidthValue / 100, P = ja - K / 2, Da = P + K / 2);
                                        K = d.roundTo(K, 2);
                                        aa = d.roundTo(aa, 2);
                                        P < q && 0 < K && (ua = new d.Cuboid(h, aa, K, H - a.d3x, S - a.d3y, Ma, Va, ca, Aa, X, ga, u, t, da, bb, mb, Z), w.columnWidth = Math.abs(aa), w.columnHeight = Math.abs(K))
                                    } else {
                                        "3d" == O ? (R = E - (r / 2 - this.depthCount + 1) * (k + T) + T / 2 + H * ea, P = M + S * ea,
                                            Ba = ea) : (R = E - (r / 2 - ea) * (k + T) + T / 2, P = M, Ba = 0);
                                        K = k;
                                        wa = R + k / 2;
                                        Da = F;
                                        ka = R + k / 2;
                                        la = F;
                                        R + K > n + Ba * H && (K = n - R + Ba * H);
                                        R < Ba * H && (K += R - Ba * H, R = Ba * H);
                                        aa = F - M;
                                        w.labelIsNegative = 0 < aa ? !0 : !1;
                                        0 === aa && -0 === W && (w.labelIsNegative = !0);
                                        var fc = P;
                                        P = d.fitToBounds(P, this.dy, q);
                                        aa += fc - P;
                                        aa = d.fitToBounds(aa, -P + S * ea, q - P);
                                        isNaN(G.percentWidthValue) || (K = this.width * G.percentWidthValue / 100, R = ja - K / 2, wa = R + K / 2);
                                        K = d.roundTo(K, 2);
                                        aa = d.roundTo(aa, 2);
                                        R < n + ea * H && 0 < K && (this.showOnAxis && (P -= S / 2), ua = new d.Cuboid(h, K, aa, H - a.d3x, S - a.d3y, Ma, Va, ca, Aa, this.lineAlpha,
                                            ga, u, t, da, bb, mb, Z), w.columnHeight = Math.abs(aa), w.columnWidth = Math.abs(K))
                                    }
                                }
                                if (ua) {
                                    Ea = ua.set;
                                    ...
                                    w.className && d.setCN(a, ua.set, w.className, !0);
                                    w.columnGraphics = Ea;
                                    R = d.roundTo(R, 2);
                                    P = d.roundTo(P, 2);
                                    Ea.translate(R, P);
                                    (w.url || this.showHandOnHover) && Ea.setAttr("cursor", "pointer");
                                    if (!I) {
                                        "none" == O && (J = t ? (this.end + 1 - L) * C - c : C * L + c);
                                        "3d" == O && (t ? (J = (this.end + 1 - L) * C - c - 1E3 * this.depthCount, wa += H * this.columnIndex, ka += H * this.columnIndex, w.y += H * this.columnIndex) :
                                            (J = (C - c) * (L + 1) + 1E3 * this.depthCount, Da += S * this.columnIndex, la += S * this.columnIndex, w.y += S * this.columnIndex));
                                        if ("regular" == O || "100%" == O) J = t ? 0 < Ia.value ? (this.end + 1 - L) * C + c : (this.end + 1 - L) * C - c : 0 < Ia.value ? C * L + c : C * L - c;
                                        this.columnsArray.push({column: ua, depth: J});
                                        w.x = t ? P + K / 2 : R + K / 2;
                                        this.ownColumns.push(ua);
                                        this.animateColumns(ua, L, E, N, F, M);
                                        this.addListeners(Ea, w)
                                    }
                            ...
                            if (!isNaN(ta) && !isNaN(W)) {
                                ...
                                if (t) {
                                    ...
                                    if (P < q && 0 < K) {
                                        ...
                                        aa = E - N;
                                        ua = new d.Cuboid(h, aa, K, H, S, Ma, Ya, ca,
                                            Aa, X, ga, u, t, da, bb, mb, Z)
                                    }
                                } else {
                                    "open" == l && (la = M);
                                    "high" == l && (la = sa);
                                    ...
                                    if (R < n && 0 < K) {
                                        Bb && W >= ta && (Va = 0);
                                        var ua = new d.Cuboid(h, K, aa, H, S, Ma, Va, ca, Aa, X, ga, u, t, da, bb, mb, Z),
                                            Fb, Gb;
                                        W > ta ? (Fb = [F, sa], Gb = [M, qa]) : (Fb = [M, sa], Gb = [F, qa]);
                                        !isNaN(sa) && !isNaN(qa) && E <
                                        n && 0 < E && (Xa = d.line(h, [E, E], Fb, Aa, X, ca), cb = d.line(h, [E, E], Gb, Aa, X, ca), d.setCN(a, Xa, this.bcn + "line-high"), w.className && d.setCN(a, Xa, w.className, !0), d.setCN(a, cb, this.bcn + "line-low"), w.className && d.setCN(a, cb, w.className, !0))
                                    }
                                }
                        ...
                        case "ohlc":
                            if (!(isNaN(ta) ||
                                ...
                                var Rb = h.set();
                                fa.push(Rb);
                                W < ta && (w.isNegative = !0, void 0 != Ja && (Ha = Ja));
                                var pb, qb, rb;
                                if (t) {
                                    la = F;
                                    ka = E;
                    ...
                    if (!I && !isNaN(W)) {
                        ...
                        if (this.end - this.start <= Ub || 0 === Ub) {
                            var Vb = this.createBullet(w, ka, la, L), Wb = this.labelText;
                            if (Wb && !isNaN(wa) && !isNaN(wa)) {
                                var gc = this.createLabel(w, Wb), Xb = 0;
                                Vb && (Xb = Vb.size);
                                this.positionLabel(w, wa, Da, gc, Xb)
                            }
                            if ("regular" == O || "100%" == O) {
                                var Yb = f.totalText;
                                if (Yb) {
                                    var Na = this.createLabel(w, Yb, f.totalTextColor);
                                    d.setCN(a,
                                        Na, this.bcn + "label-total");
                                    this.allBullets.push(Na);
                                    if (Na) {
                                        var Zb = Na.getBBox(), $b = Zb.width, ac = Zb.height, db, eb,
                                            sb = f.totalTextOffset, bc = f.totals[L];
                                        bc && bc.remove();
                                        var fb = 0;
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g) "smoothedLine" == g ? this.drawSmoothedGraph(z, v, U, V) : this.drawLineGraph(z,
                v, U, V), I || this.launchAnimation();
            ...
            if (1 <
                ...
                u && (t = u);
                var u = h.fillColorsR, x = h.fillColorsSwitched;
                x && (u = x);
                var z = h.dashLength;
                (x = h.dashLengthSwitched) && (z = x);
                var x = h.negativeLineColor, v = h.negativeFillColors, A = h.negativeFillAlphas, y = h.baseCoord;
                0 !== h.negativeBase && (y = h.valueAxis.getCoordinate(h.negativeBase, f), y > h.height &&
                (y = h.height), 0 > y && (y = 0));
                q = d.line(l, a, b, t, q, p, z, !1, !0, f);
                ...
                void 0 === x || h.useNegativeColorIfDown || (p = d.line(l, a, b, x, r, p, z, !1, !0, f), d.setCN(k, p, h.bcn + "stroke"), d.setCN(k, p, h.bcn + "stroke-negative"),
                    n.push(p));
            ...
            if (1 < a.length) {
                var h = this.set,
                    f = this.chart, g = this.container, k = g.set(), l = g.set();
                h.push(l);
                h.push(k);
                var m = this.lineAlpha, n = this.lineThickness, h = this.dashLength, q = this.fillAlphas,
                    ...
                    x = this.negativeFillAlphas, z = this.baseCoord, v = this.lineColorSwitched;
                v && (p = v);
                (v = this.fillColorsSwitched) && (t = v);
                var A = this.negativeLineAlpha;
                isNaN(A) && (A = m);
                v = this.getGradRotation();
                m = new d.Bezier(g, a, b, p, m, n, t, 0, h, void 0, v);
                d.setCN(f, m, this.bcn + "stroke");
                k.push(m.path);
                void 0 !== r && (n = new d.Bezier(g, a, b, r, A, n, t, 0, h, void 0, v), d.setCN(f, n, this.bcn + "stroke"), d.setCN(f, n, this.bcn + "stroke-negative"), l.push(n.path));
                0 < q && (m = a.join(";").split(";"), p = b.join(";").split(";"), n = "", 0 < c.length ? (c.push("M"), e.push("M"), c.reverse(), e.reverse(), m = a.concat(c), p = b.concat(e)) : (this.rotate ? (n += " L" + z + "," + b[b.length - 1], n += " L" + z + "," + b[0]) : (n += " L" + a[a.length - 1] + "," + z, n += " L" + a[0] + "," + z), n += " L" + a[0] + "," + b[0]), c = new d.Bezier(g, m, p, NaN, 0, 0, t, q, h, n, v), d.setCN(f, c, this.bcn + "fill"), c.path.pattern(this.pattern,
                    NaN, f.path), k.push(c.path), u || void 0 !== r) && (x || (x = q), u || (u = r), a = new d.Bezier(g, a, b, NaN, 0, 0, u, x, h, n, v), a.path.pattern(this.pattern, NaN, f.path), d.setCN(f, a, this.bcn + "fill"), d.setCN(f, a, this.bcn + "fill-negative"), l.push(a.path));
                this.applyMask(l, k)
            }
            ...
            if (!isNaN(b) &&
                !isNaN(c) && ("none" != this.bullet || this.customBullet || a.bullet || a.customBullet)) {
                ...
                this.rotate ? b = a.isNegative ? b -
                    f : b + f : c = a.isNegative ? c + f : c - f;
                q = this.bulletColorR;
                ...
                (m = this.lineColorR, a.isNegative && this.negativeLineColor && (m = this.negativeLineColor), this.lineColorSwitched && (m = this.lineColorSwitched));
                var r = a.alpha;
                isNaN(r) || (t = r);
                p = d.bullet(h, f, g, q, t, k, m, n, l, 0, p, e.path);
                l = this.customBullet;
                a.customBullet && (l = a.customBullet);
                l && (p && p.remove(), "function" == typeof l ? (l = new l, l.chart = e, a.bulletConfig && (l.availableSpace = c, l.graph = this, l.graphDataItem = a, l.bulletY = c, a.bulletConfig.minCoord = this.minCoord - c, l.bulletConfig = a.bulletConfig), l.write(h), p && l.showBullet && l.set.push(p),
                    a.customBulletGraphics = l.cset, p = l.set) : (p = h.set(), l = h.image(l, 0, 0, g, g), p.push(l), this.centerCustomBullets && l.translate(-g / 2, -g / 2)));
                if (p) {
                ...
                if (p) {
                    p.size = g || 0;
                    if (e =
                        this.bulletHitAreaSize) h = d.circle(h, e, "#FFFFFF", .001, 0), h.translate(b, c), a.hitBullet = h, this.bulletSet.push(h), this.addListeners(h, a);
                    a.bulletGraphics = p
                } else p = {size: 0};
                p.graphDataItem = a;
                return p
        ...
        hideBalloonReal: function () {
            ...
            m ? m.valueBalloonsEnabled || (g = f.balloon, k = this.x, l = this.y, n = !1) :
                (g = f.balloon, k = this.x, l = this.y, n = !1);
            ...
            if (g && g.enabled && this.showBalloon && !this.hidden) {
                ...
                m && "" !== m ? (e = f.getBalloonColor(this, a), g.drop || (g.pointerOrientation = b), b = a.x, h = a.y, f.rotate && (b = a.y,
                    h = a.x), b += k, h += l, isNaN(b) || isNaN(h) ? this.hideBalloonReal() : (a = this.width, q = this.height, n && g.setBounds(k, l, a + k, q + l), g.changeColor(e), g.setPosition(b, h), g.fixPrevious(), g.fixedPosition && (c = !1), !c && "radar" != f.type && (b < k || b > a + k || h < l - .5 || h > q + l) ? (g.showBalloon(m), g.hide(0)) : (g.followCursor(c), g.showBalloon(m)))) : (this.hideBalloonReal(), this.resizeBullet(a, e, h))
...
(function () {
    ...
    d.ChartCursor = d.Class({
        construct: function (a) {
            ...
            this.hhLine = d.line(this.container, [0, e, e + b], [0, 0, c],
                this.cursorColor, g, 1);
            ...
            this.zooming && this.fullWidth && this.selection &&
            ...
            if (!this.pan && this.enabled) {
                ...
                isNaN(this.mouse2X) && 0 < Math.abs(h) &&
                0 < Math.abs(f) && (a = this.chart, b = d.rect(this.container, h, f, this.cursorColor, this.selectionAlpha), d.setCN(a, b, "cursor-selection"), b.width = h, b.height = f, b.translate(c, e), this.set.push(b), this.selection = b);
                this.updateFullLine()
            }
            ...
            if (this.drawingNow) {
                ...
                (2 < Math.abs(a - c) || 2 < Math.abs(b - e)) && this.fire({
                    type: "draw", target: this, chart: h,
                    initialX: a, initialY: b, finalX: c, finalY: e
                })
            }
            ...
            if (!this.pan) {
                ...
                if (b && 3 < Math.abs(b.width) && 3 < Math.abs(b.height)) {
                    var c = Math.min(this.index, this.index0), e = Math.max(this.index,
                        this.index0), d = c, f = e, g = this.chart, k = g.chartData, l = g.categoryAxis;
            ...
            if (this.mouseIsDown) {
                var a = d.roundTo((this.mouseX - this.mouseX0) / this.width, 3), b = d.roundTo((this.mouseY -
                    this.mouseY0) / this.height, 3), c = d.roundTo((this.mouse2X - this.mouse2X0) / this.width, 3),
                    e = d.roundTo((this.mouse2Y - this.mouse2Y0) / this.height, 2), h = !1;
                ...
                h && (this.hideLines(), this.fire({
                    ...
                    b, this.prevDelta2X = c, this.prevDelta2Y = e)
            }
    ...
    d.SimpleChartScrollbar = d.Class({
        construct: function (a) {
            ...
            if (a.enabled) {
                ...
                var f, g;
                c ? (f = a.scrollbarHeight, g = e.plotAreaHeight) : (g =
                    a.scrollbarHeight, f = e.plotAreaWidth);
                a.width = f;
                if ((a.height = g) && f) {
                    ...
                    c ? (k = f + g + "H" + e.extension, f = a.dragIconWidth, c = a.dragIconHeight) : (k = f + g + e.extension, c =
                        a.dragIconWidth, f = a.dragIconHeight);
                    g = b.image(k, 0, 0, c, f);
            ...
            if (k) {
                ...
                if (n.mouseIsOver) {
                    this.dragging &&
                    (n = this.initialCoord, m ? (a = n + (r - a), 0 > a && (a = 0), n = p - k, a > n && (a = n), g.setAttr("y", a)) : (a = n + (t - a), 0 > a && (a = 0), n = q - l, a > n && (a = n), g.setAttr("x", a)), this.clipDragger(!0));
                    if (this.resizingRight) {
                        if (m) if (a = r - e, a + e > p + f && (a = p - e + f), 0 > a) this.resizingRight = !1, b = this.resizingLeft = !0; else {
                            if (0 === a || isNaN(a)) a = .1;
                            g.setAttr("height", a)
                    ...
                    if (this.resizingLeft) {
                        if (m) if (c = e,
                            e = r, e < f && (e = f), isNaN(e) && (e = f), e > p + f && (e = p + f), a = !0 === b ? c - e : k + c - e, 0 > a) this.resizingRight = !0, this.resizingLeft = !1, g.setAttr("y", c + k - f); else {
                            if (0 === a || isNaN(a)) a = .1;
                            g.setAttr("y", e - f);
                            g.setAttr("height", a)
            ...
            var a = this.getDBox(),
                b = a.x, c = a.y, e = this.iconLeft, d = this.iconRight, f, g, k = this.scrollbarHeight;
            ...
            if (!this.resizingLeft && !this.resizingRight && !this.dragging) {
                if (this.hideResizeGrips ||
                    !this.resizeEnabled) this.iconLeft.hide(), this.iconRight.hide();
                this.removeCursors()
            }
        ...
        destroy: function () {
            ...
            if (!a.resizingRight && !a.resizingLeft) {
                ...
                a.updateOnReleaseOnly ? (a.skipEvent = !1, h.setAttr(b, c), a.dispatchScrollbarEvent(), a.clipDragger()) :
                    (a.animating = !0, c = Math.round(c), m ? h.animate({y: c}, e, ">") : h.animate({x: c}, e, ">"), a.forceClip = !0, clearTimeout(a.forceTO), a.forceTO = setTimeout(function () {
            ...
            if (this.set) {
                ...
                this.animating = this.mouseIsOver = this.dragging = this.resizingRight =
                    this.resizingLeft = !1;
                this.hideDragIcons();
                this.update()
            }
...
(function () {
    ...
    d.ChartScrollbar = d.Class({
        inherits: d.SimpleChartScrollbar, construct: function (a) {
            ...
            (a = this.graph) && this.catScrollbar && (c = this.valueAxis, c || (this.valueAxis = c = new d.ValueAxis, c.visible = !1, c.scrollbar = !0, c.axisItemRenderer =
            ...
            if (a.enabled) {
                ...
                e.parseDates && !e.equalSpacing && e.timeZoom(b.firstTime,
                    b.lastTime);
            ...
            if ((!(this.dragging || this.resizingLeft ||
                this.resizingRight || this.animating) || a) && this.dragger && this.enabled) {
                var b;
                a = this.chart;
...
(function () {
    ...
    d.AmBalloon = d.Class({
        construct: function (a) {
            ...
            if (!isNaN(a)) {
                var e =
                    this.follow, h = c.container, f = this.set;
                d.remove(f);
                this.removeDiv();
                f = h.set();
                f.node.style.pointerEvents = "none";
                ...
                if (this.show) {
                    ...
                    var r = this.horizontalPadding, u = this.verticalPadding, x = this.pointerWidth,
                        z = this.pointerOrientation, v = this.cornerRadius,
                    ...
                    n.innerHTML = '<div style="text-align:' + this.textAlign + "; " + C + "max-width:" + this.maxWidth + "px; font-size:" + y + "px; color:" + this.color + "; font-family:" +
                        A + '">' + this.text + "</div>";
                    c.chartDiv.appendChild(n);
                    this.textDiv = n;
                    var J = n.offsetWidth, H = n.offsetHeight;
                    n.clientHeight && (J = n.clientWidth, H = n.clientHeight);
                    A = H + 2 * u;
                    C = J + 2 * r;
                    !isNaN(D) && C < D && (C = D);
                    window.opera && (A += 2);
                    var S = !1, y = this.offsetY;
                    c.handDrawn && (y += c.handDrawScatter + 2);
                    "H" != z ? (D = a - C / 2, b < k + A + 10 && "down" != z ? (S = !0, e && (b += y), y = b + x, this.deltaSignY = -1) : (e && (b -= y), y = b - A - x, this.deltaSignY = 1)) : (2 * x > A && (x = A / 2), y = b - A / 2, a < g + (l - g) / 2 ? (D = a + x, this.deltaSignX = -1) : (D = a - C - x, this.deltaSignX = 1));
                    y + A >= m && (y = m - A);
                    y < k && (y = k);
                    D < g && (D = g);
                    D + C > l && (D = l - C);
                    var k = y + u, m = D + r, O = this.shadowAlpha, Q = this.shadowColor, r = this.borderThickness,
                        ia = this.bulletSize, I, u = this.fillAlpha, Z = this.borderAlpha;
                    this.showBullet && (I = d.circle(h, ia, t, u), f.push(I));
                    this.drop ? (g = C / 1.6, l = 0, "V" == z && (z = "down"), "H" == z && (z = "left"), "down" == z && (D = a + 1, y = b - g - g / 3), "up" == z && (l = 180, D = a + 1, y = b + g + g / 3), "left" == z && (l = 270, D = a + g + g / 3 + 2, y = b), "right" == z && (l = 90, D = a - g - g / 3 + 2, y = b), k = y - H / 2 + 1, m = D - J / 2 - 1, q = d.drop(h, g, l, q, u, r, p, Z)) : 0 < v || 0 === x ? (0 < O && (a = d.rect(h, C, A, q, 0, r + 1,
                        Q, O, v), d.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), q = d.rect(h, C, A, q, u, r, p, Z, v)) : (t = [], v = [], "H" != z ? (g = a - D, g > C - x && (g = C - x), g < x && (g = x), t = [0, g - x, a - D, g + x, C, C, 0, 0], v = S ? [0, 0, b - y, 0, 0, A, A, 0] : [A, A, b - y, A, A, 0, 0, A]) : (z = b - y, z > A - x && (z = A - x), z < x && (z = x), v = [0, z - x, b - y, z + x, A, A, 0, 0], t = a < g + (l - g) / 2 ? [0, 0, D < a ? 0 : a - D, 0, 0, C, C, 0] : [C, C, D + C > a ? C : a - D, C, C, 0, 0, C]), 0 < O && (a = d.polygon(h, t, v, q, 0, r, Q, O), a.translate(1, 1), f.push(a)), q = d.polygon(h, t, v, q, u, r, p, Z));
                    this.bg = q;
                    f.push(q);
                    q.toFront();
                    ...
                    this.bottom = y + A + 1;
                    this.yPos = q.y + y;
                    I && I.translate(this.pointToX - D + h, b - y);
                    b = this.animationDuration;
                    0 < this.animationDuration && !e && !isNaN(this.prevX) && (f.translate(this.prevX, this.prevY, NaN, !0), f.animate({translate: D - h + "," + y}, b, "easeOutSine"), n && (B.left = this.prevTX + "px", B.top = this.prevTY + "px", this.xAnim = c.animate({node: n}, "left", this.prevTX, m, b, "easeOutSine",
                        "px"), this.yAnim = c.animate({node: n}, "top", this.prevTY, k, b, "easeOutSine", "px")));
                    this.prevX = D - h;
                    this.prevY = y;
                    this.prevTX = m;
                    this.prevTY = k
    ...
    d.AmCoordinateChart = d.Class({
        inherits: d.AmChart, construct: function (a) {
            ...
            k && (t = d.extractPeriod(m.minPeriod),
                r = t.period, t = t.count, x = d.getPeriodDuration(r, t));
            var z = {};
            this.lookupTable = z;
            var v, A = this.dataDateFormat, y = {};
            for (v = b; v < c; v++) {
                var B = {}, D = a[v];
                ...
                for (J = 0; J < C.length; J++) {
                    ...
                    for (S = 0; S < h.length; S++) {
                        ...
                        if (b.valueAxis.id == H) {
                            ...
                            !b.connect && y && y[O] && 0 < Q && B.time - u[O] >= x * Q && (y[O].gap = !0);
            ...
            for (var g = "value error open close low high".split(" "), k = 0; k < g.length; k++) {
                ...
                var m = a[b[l + "Field"] + c];
                null !== m && (h = Number(m),
                isNaN(h) || (e[l] = h), "date" == b.valueAxis.type && void 0 !== m && (h = d.getDate(m, b.chart.dataDateFormat), e[l] = h.getTime()))
            }
            return e
            ...
            var b = this.graphs, c;
            for (c =
                     b.length - 1; 0 <= c; c--) b[c] == a && (b.splice(c, 1), a.destroy());
            this.validateData()
            ...
            return d.getObjById(this.graphs,
                a)
    ...
    d.TrendLine = d.Class({
        construct: function (a) {
            ...
            var b = a.chart, c = b.container, e, h, f, g, k = a.categoryAxis, l = a.initialDate, m = a.initialCategory,
                ...
                u = a.finalXValue, x = a.initialValue, z =
                    a.finalValue, v = p.recalculateToPercents, A = b.dataDateFormat;
            ...
            p && !v && (isNaN(x) || (f = p.getCoordinate(x)), isNaN(z) || (g = p.getCoordinate(z)));
...
(function () {
    ...
    d.makeHD = function (a, b, c) {
        for (var d = [], h = [], f = 1; f < a.length; f++) for (var g = Number(a[f - 1]), k = Number(b[f - 1]), l = Number(a[f]), m = Number(b[f]),
                                                                    n = Math.round(Math.sqrt(Math.pow(l - g, 2) + Math.pow(m - k, 2)) / 50) + 1, l = (l - g) / n, m = (m - k) / n, q = 0; q <= n; q++) {
    ...
    d.drop = function (a, b, c, d, h, f, g, k) {
        var l = 1 / 180 * Math.PI, m = c - 20, n = Math.sin(m * l) * b, q = Math.cos(m * l) * b,
            p = Math.sin((m + 40) * l) * b, t = Math.cos((m + 40) * l) * b, r = .8 * b, u = -b / 3, x = b / 3;
        0 === c && (u = -u, x = 0);
        180 == c && (x = 0);
        90 == c && (u = 0);
        270 == c && (u = 0, x = -x);
    ...
    d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, q, p, t) {
        ...
        g = r(g);
        k = r(k);
        var u = r(g / f * k), x = d.VML, z = 359.5 + f / 100;
        359.94 < z && (z = 359.94);
        h >= z && (h = z);
        var v = 1 / 180 * Math.PI, z = b + Math.sin(e * v) * k, A = c - Math.cos(e * v) * u,
            y = b + Math.sin(e * v) * f, B = c - Math.cos(e * v) * g, D = b + Math.sin((e + h) * v) * f,
            C = c - Math.cos((e + h) * v) * g, J = b + Math.sin((e + h) * v) * k, v = c - Math.cos((e + h) * v) * u,
            H = {fill: d.adjustLuminosity(m.fill, -.2), "stroke-opacity": 0, "fill-opacity": m["fill-opacity"]}, S = 0;
        180 < Math.abs(h) && (S = 1);
        e = a.set();
        var O;
        x && (z = r(10 * z), y = r(10 * y), D = r(10 * D), J = r(10 * J), A = r(10 * A), B = r(10 * B), C = r(10 * C), v = r(10 * v), b = r(10 * b), l = r(10 * l), c = r(10 * c), f *= 10, g *= 10, k *= 10, u *= 10, 1 > Math.abs(h) && 1 >= Math.abs(D - y) && 1 >= Math.abs(C - B) && (O = !0));
        h = "";
        var Q;
        q && (H["fill-opacity"] = 0, H["stroke-opacity"] = m["stroke-opacity"] / 2, H.stroke = m.stroke);
        if (0 < l) {
            Q = " M" + z + "," + (A + l) + " L" + y + "," + (B + l);
            x ? (O || (Q += " A" + (b - f) + "," + (l + c - g) + "," + (b + f) + "," + (l + c + g) + "," + y + "," + (B + l) + "," + D + "," + (C + l)), Q += " L" + J + "," + (v + l), 0 < k && (O || (Q += " B" + (b - k) + "," + (l + c - u) + "," + (b + k) + "," +
                (l + c + u) + "," + J + "," + (l + v) + "," + z + "," + (l + A)))) : (Q += " A" + f + "," + g + ",0," + S + ",1," + D + "," + (C + l) + " L" + J + "," + (v + l), 0 < k && (Q += " A" + k + "," + u + ",0," + S + ",0," + z + "," + (A + l)));
            Q += " Z";
            var ia = l;
            x && (ia /= 10);
            for (var I = 0; I < ia; I += 10) {
                var Z = a.path(Q, void 0, void 0, "1000,1000").attr(H);
                e.push(Z);
                Z.translate(0, -I)
            }
            Q = a.path(" M" + z + "," + A + " L" + z + "," + (A + l) + " L" + y + "," + (B + l) + " L" + y + "," + B + " L" + z + "," + A + " Z", void 0, void 0, "1000,1000").attr(H);
            l = a.path(" M" + D + "," + C + " L" + D + "," + (C + l) + " L" + J + "," + (v + l) + " L" + J + "," + v + " L" + D + "," + C + " Z", void 0, void 0,
                "1000,1000").attr(H);
            e.push(Q);
            e.push(l)
        }
        x ? (O || (h = " A" + r(b - f) + "," + r(c - g) + "," + r(b + f) + "," + r(c + g) + "," + r(y) + "," + r(B) + "," + r(D) + "," + r(C)), g = " M" + r(z) + "," + r(A) + " L" + r(y) + "," + r(B) + h + " L" + r(J) + "," + r(v)) : g = " M" + z + "," + A + " L" + y + "," + B + (" A" + f + "," + g + ",0," + S + ",1," + D + "," + C) + " L" + J + "," + v;
        0 < k && (x ? O || (g += " B" + (b - k) + "," + (c - u) + "," + (b + k) + "," + (c + u) + "," + J + "," + v + "," + z + "," + A) : g += " A" + k + "," + u + ",0," + S + ",0," + z + "," + A);
        a.handDrawn && (k = d.line(a, [z, y], [A, B], m.stroke, m.thickness * Math.random() * a.handDrawThickness, m["stroke-opacity"]),
            e.push(k));
        a = a.path(g + " Z", void 0, void 0, "1000,1000").attr(m);
        if (n) {
            k = [];
            for (u = 0; u < n.length; u++) k.push(d.adjustLuminosity(m.fill, n[u]));
    ...
    d.Bezier = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m, n) {
            ...
            var h = Math.round, f = this.getPointOnSegment(a, b, .75), g = this.getPointOnSegment(d, c, .75),
                k = (d.x - a.x) / 16, l = (d.y - a.y) / 16, m = this.getPointOnSegment(a,
                b, .375);
    ...
    d.AmDraw = d.Class({
        construct: function (a, b, c, e) {
            ...
            if (d.hasSVG) {
                ...
                a && (a.addCodeCredits && b.appendChild(document.createTextNode("JavaScript chart by amCharts " + a.version)), c.appendChild(b), a.defs && (b = this.createSvgElement("defs"), c.appendChild(b),
                    d.parseDefs(a.defs, b), this.defs = b))
            }
        }
    })
})();
    ...
    d.SVGRenderer = d.Class({
        construct: function (a) {
            ...
            for (a = b.length - 1; 0 <= a; a--) {
                ...
                h <= e ? (c.frame++, "translate" == g ? (k = c.from.split(","), g = Number(k[0]), k = Number(k[1]), isNaN(k) && (k = 0), l = c.to.split(","), m = Number(l[0]), l = Number(l[1]), m =
...
(function () {
    ...
    d.AmLegend = d.Class({
        construct: function (a) {
            ...
            (c = f.clientWidth, h = f.clientHeight)) : (isNaN(c) || (f.style.width = c + "px"), f.className = "amChartsLegend " + a.classNamePrefix + "-legend-div");
            this.divWidth = c;
            ...
            this.titleWidth = 0;
            if (h = this.title) h = d.text(this.container, h, this.color, a.fontFamily,
                this.fontSize, "start", !0), d.setCN(a, h, "legend-title"), h.translate(this.marginLeft, this.marginTop + this.verticalGap + this.ly + 1), a = h.getBBox(), this.titleWidth = a.width + 15, this.titleHeight = a.height + 6;
            ...
            for (A = 0; A < z.length; A++) {
                var J = z[A];
                this.reversedOrder && (J = z[z.length - A - 1]);
                v = J.getBBox();
                var H;
                this.equalWidths ? H = y * (p + n + this.markerLabelGap) :
                    (H = B, B = B + v.width + f + n);
                v.height > C && (C = v.height);
                H + v.width > q && 0 < A && 0 !== y && (t++, H = y = 0, B = H + v.width + f + n, D = D + C + m, C = 0);
                J.translate(H, D);
                y++;
            ...
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (this.useGraphSettings) {
                    ...
                    if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c) g = l.set(), a.hidden || (e = a.lineColorR, f = a.bulletBorderColorR), n = d.line(l, [0, 2 * m], [m / 2, m / 2], e, a.lineAlpha, a.lineThickness, a.dashLength), d.setCN(b,
                        n, "graph-stroke"), g.push(n), a.bullet && (a.hidden || (e = a.bulletColorR), n = d.bullet(l, a.bullet, a.bulletSize, e, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (d.setCN(b, n, "graph-bullet"), n.translate(m + 1, m / 2), g.push(n)), p = 0, n = m, q = m / 3; else {
                        var t;
...
(function () {
    ...
    d.resetDateToMin = function (a, b, c, e) {
        void 0 === e && (e = 1);
        var h, f, g, k, l, m, n;
        d.useUTC ? (h = a.getUTCFullYear(), f = a.getUTCMonth(), g = a.getUTCDate(), k = a.getUTCHours(), l = a.getUTCMinutes(), m = a.getUTCSeconds(), n = a.getUTCMilliseconds(), a = a.getUTCDay()) : (h = a.getFullYear(), f = a.getMonth(), g = a.getDate(), k = a.getHours(), l =
        ...
        d.useUTC ? (a = new Date, a.setUTCFullYear(h, f, g), a.setUTCHours(k, l, m, n)) : a = new Date(h, f, g,
            k, l, m, n);
        return a
    };
