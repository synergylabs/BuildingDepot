...
invalid_tagtypes = {
    'success': 'False',
    'error': 'One of the tagtypes does not exist'
}
tagtype_in_use = {
    'success': 'False',
...
permission_not_defined = {
    'success': 'False',
    'error': 'Permission is not defined'
}
...
sensorgroup_exists = {
    'success': 'False',
    'error': 'Sensorgroup already exists'
}
no_sensorgroup_tags = {
    'success': 'False',
...
sensorgroup_used = {
    ...
    'False',
    'error':
    'Sensor group tags cannot be edited. Already being used for '
    'permissions'
}
...
no_search_parameters = {
    'success': 'False',
    'error': 'No search parameters specified'
}
...
super_user_required = {
    'success': 'False',
    'error': 'Super user privileges required. Not authorized for this '
    'operation'
}
# not used
...
acl_tag_superuser = {
    ...
    'False',
    'error':
    'Super user privileges required. Not authorized to change '
