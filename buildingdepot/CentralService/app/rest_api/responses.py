...
super_user_required = {'success': 'False',
                       'error': 'Super user privileges required. You are not authorized for this operation'}
acl_tag_superuser = {'success': 'False',
                     'error': 'Super user privileges required. You are not authorized to change the usage of this tag'}
