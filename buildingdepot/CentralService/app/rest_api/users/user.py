...
class UserService(MethodView):
    ...
    def post(self):
        ...
        # check whether all the parametes are appropriately received
        ...
        # check whether the role is well formed
    ...
    def get(self, email):
        ...
        # checkk whether the target user exists
        if user is None:
    ...
    def delete(self, email):
        ...
        # chech whether the specified user exists
        if user is None:
            return jsonify(responses.invalid_user)
