...
def register_view(app_obj):
    ...
    #use post to delete a sensor group?
    ...
    # get info regarding a specified user group (but not users?)
    app_obj.add_url_rule('/api/user_group/<name>',view_func=usergroup_view,methods=['GET'])
    #no method to list what user groups exist.
    #use post to delete a user group?
    ...
    #use post to delete a user from a user group?
    ...
    #post sets the value of the permission-pair to an eligable value: r r/w r/w/p d/w - possible issues
    #delete deletes the permission pair.
    ...
    #using post instead of get may require explanation
    ...
    #post changes/adds a data service to a central service (but does not create it)
    #get returns info on the specified data service
    #delete unregisters a data service from a central service (but does not erases it)
    ...
    #delete removes a building from a data service (possibly destroying data as well)
