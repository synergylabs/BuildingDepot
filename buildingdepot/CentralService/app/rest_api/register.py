...
def register_view(app_obj):
    ...
    # add/change tagtypes
    app_obj.add_url_rule('/api/tagtype',
                         view_func=tagtype_view,
                         methods=['POST'])
    # get info regarding a tagtype, delete a tag type
    app_obj.add_url_rule('/api/tagtype/<name>',
                         view_func=tagtype_view,
                         methods=['GET', 'DELETE'])

    template_view = buildingtemplate.BuildingTemplateService.as_view(
        'template_api')
    # post creates/modifies building templates
    # get returns information on a specified building template.
    # delete deletes the template
    app_obj.add_url_rule('/api/template',
                         view_func=template_view,
                         methods=['POST'])
    app_obj.add_url_rule('/api/template/<name>',
                         view_func=template_view,
                         methods=['GET', 'DELETE'])
    ...
    # get returns information on a specified building template.
    # delete deletes the template
    app_obj.add_url_rule('/api/template/<name>/tags',
    ...
    app_obj.add_url_rule('/api/building',
                         view_func=building_view,
                         methods=['POST'])
    app_obj.add_url_rule('/api/building/<name>',
                         view_func=building_view,
                         methods=['GET', 'DELETE'])

    building_tags_view = building_tags.BuildingTagsService.as_view(
        'building_tags_api')
    ...
    app_obj.add_url_rule('/api/building/<building_name>/tags',
                         view_func=building_tags_view,
                         methods=['POST', 'GET', 'DELETE'])

    dataservice_view = dataservice.DataserviceService.as_view(
        'dataservice_api')
    ...
    app_obj.add_url_rule('/api/dataservice',
                         view_func=dataservice_view,
                         methods=['POST'])
    app_obj.add_url_rule('/api/dataservice/<name>',
                         view_func=dataservice_view,
                         methods=['GET', 'DELETE'])
    ...
    app_obj.add_url_rule('/api/dataservice/<name>/buildings',
    ...
    app_obj.add_url_rule('/api/dataservice/<name>/admins',
                         view_func=ds_admins_view,
                         methods=['POST', 'GET', 'DELETE'])

    sensor_view = sensor.SensorService.as_view('sensor_api')
    # get sensor by name
    app_obj.add_url_rule('/api/sensor/<name>',
                         view_func=sensor_view,
                         methods=['GET', 'DELETE'])
    # create a new sensor
    app_obj.add_url_rule('/api/sensor',
                         view_func=sensor_view,
                         methods=['POST'])

    sensor_view_view = sensor_views.SensorViewService.as_view(
        'sensor_view_api')
    # get views of sensor by name
    app_obj.add_url_rule('/api/sensor/<name>/views',
                         view_func=sensor_view_view,
                         methods=['GET'])
    # delete views of sensor by name
    app_obj.add_url_rule('/api/sensor/<name>/views/<uuid>',
                         view_func=sensor_view_view,
                         methods=['DELETE'])
    ...
    app_obj.add_url_rule('/api/sensor/<name>/tags',
                         view_func=sensortags_view,
                         methods=['GET', 'POST'])

    sensorgroup_view = sensorgroup.SensorGroupService.as_view(
        'sensorgroup_api')
    # post creates an new sensor group
    app_obj.add_url_rule('/api/sensor_group',
                         view_func=sensorgroup_view,
                         methods=['POST'])
    # get a list of sensors in a specified sensor group
    app_obj.add_url_rule('/api/sensor_group/<name>',
                         view_func=sensorgroup_view,
                         methods=['GET'])
    ...
    app_obj.add_url_rule('/api/sensor_group/<name>/tags',
                         view_func=sgtags_view,
                         methods=['GET', 'POST'])

    usergroup_view = usergroup.UserGroupService.as_view('usergroup_api')
    # post creates a new user group
    app_obj.add_url_rule('/api/user_group',
                         view_func=usergroup_view,
                         methods=['POST'])
    app_obj.add_url_rule('/api/user_group/<name>',
                         view_func=usergroup_view,
                         methods=['GET'])
    # delete a user group
    app_obj.add_url_rule('/api/user_group/<name>',
    ...
    app_obj.add_url_rule('/api/user_group/<name>/users',
                         view_func=ugusers_view,
                         methods=['GET', 'POST'])

    permission_view = permission.PermissionService.as_view(
        'permission_service')
    ...
    app_obj.add_url_rule('/api/permission',
    ...
    app_obj.add_url_rule('/api/sensor/search',
    ...
    app_obj.add_url_rule('/api/user/<email>',
